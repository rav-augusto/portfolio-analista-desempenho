...
const PESOS: Record<Arquetipo, Partial<Record<DimKey, number>>> = {
  GK: { inteligencia: 2.5, concentracao_def: 2.5, atitude: 2, cobertura_defensiva: 2, equilibrio_defensivo: 1.8, tecnica: 1.5, um_contra_um: 1.5, forca: 1.5, contencao: 1.5, penetracao: 0.3, cobertura_ofensiva: 0.4, espaco_com_bola: 0.4, espaco_sem_bola: 0.3, mobilidade: 0.4, unidade_ofensiva: 0.5, dinamica: 0.7 },
  ZAG: { contencao: 3, cobertura_defensiva: 3, concentracao_def: 2.5, equilibrio_defensivo: 2.5, forca: 2.5, inteligencia: 2.3, um_contra_um: 2, unidade_defensiva: 2, atitude: 2, equilibrio_recuperacao: 1.8, velocidade: 1.3, penetracao: 0.4, mobilidade: 0.4, espaco_sem_bola: 0.5, unidade_ofensiva: 0.6, cobertura_ofensiva: 0.7, espaco_com_bola: 0.8 },
