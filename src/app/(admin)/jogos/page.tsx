...
import { Plus, Pencil, Trash2, Calendar, Play, Filter, X, Trophy, MapPin } from 'lucide-react'
      ...
      {showFilters && (
        <div className="bg-slate-800 rounded-2xl p-4 shadow-sm border border-slate-700 mb-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div>
              <label className="block text-[10px] font-medium text-slate-500 uppercase mb-1">Competicao</label>
              <select
            ...
            <div>
              <label className="block text-[10px] font-medium text-slate-500 uppercase mb-1">Periodo</label>
              <select
                value={filtroPeriodo}
