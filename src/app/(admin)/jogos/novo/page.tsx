  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-100">Novo Jogo</h1>
          <p className="text-sm sm:text-base text-slate-400 mt-1">Adicione um novo jogo</p>
        </div>
      </div>
