                ...
                {avaliacoes.length > 0 && (
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      title="Gerar análise técnica do atleta"
                    >
          ...
          {(analiseIA || erroIA || loadingIA) && (
            <div className="rounded-2xl p-4 md:p-6 shadow-sm mb-4 md:mb-6" style={{ backgroundColor: '#1e293b', border: '1px solid #7c3aed55' }}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base md:text-lg font-semibold text-slate-100">Análise do Atleta</h3>
                <span className="text-[10px] text-slate-500">gerada a partir dos dados</span>
              </div>
                  ...
                  {comparativoPosicao && (
                    <div className="mt-4 rounded-xl p-3" style={{ backgroundColor: '#0f172a', border: '1px solid #475569' }}>
                      ...
                      <p className="text-[11px] text-slate-400 mb-3">
                        Como este atleta se compara com a média de quem joga na mesma posição. O % à direita mostra o quanto ele está acima (verde) ou abaixo (vermelho) dessa média.
                      </p>
                ...
                <div className="rounded-2xl p-4 md:p-6 shadow-sm mb-4 md:mb-6" style={{ backgroundColor: '#1e293b', border: '1px solid #475569' }}>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 hidden sm:block">Índice de desenvolvimento, maturação e evolução física</p>
                    </div>
                  </div>
